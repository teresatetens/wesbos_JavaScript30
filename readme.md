#### Here is my note to original readme:

I've heard from this tutorial many times but I haven't visited yet. Lately it came to my mind that I should revisit JavaScript: And this course is perfect. It opened my eyes again. Thanks, Wes for the great material!

#### My Approach:

I tried to figure out by myself but not too long because I wanted to learn clean and lean approach of Wes. I added extra exercises those Wes recommended to.

**My solutions** are index_TERESA.html or script_TERESA.js.  **The Solution from Wes**, which named  index_FINISHED.html or script_FINISHED.js was untouched so that I can refer later.
